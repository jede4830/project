...
k3s kubectl apply -f redis/redis-deployment.yaml
k3s kubectl apply -f redis/redis-service.yaml
k3s kubectl apply -f rabbitmq/rabbitmq-deployment.yaml
k3s kubectl apply -f rabbitmq/rabbitmq-service.yaml
#k3s kubectl apply -f logs/logs-deployment.yaml
